...
ALTER TABLE ClienteFone
ADD CONSTRAINT fk_cliente_clientefone
FOREIGN KEY (id_cliente) REFERENCES Cliente(id_cliente);

ALTER TABLE ClienteFone
ADD CONSTRAINT fk_fone_clientefone
FOREIGN KEY (id_fone) REFERENCES Fone(id_fone);

ALTER TABLE ClienteEmail
ADD CONSTRAINT fk_cliente_clienteemail
FOREIGN KEY (id_cliente) REFERENCES Cliente(id_cliente);

ALTER TABLE ClienteEmail
ADD CONSTRAINT fk_email_clienteemail
...
ALTER TABLE FilialFone
ADD CONSTRAINT fk_filial_filialfone
FOREIGN KEY (id_filial) REFERENCES Filial(id_filial);

ALTER TABLE FilialFone
ADD CONSTRAINT fk_fone_filialfone
FOREIGN KEY (id_fone) REFERENCES Fone(id_fone);

ALTER TABLE FilialEmail
ADD CONSTRAINT fk_filial_filialemail
FOREIGN KEY (id_filial) REFERENCES Filial(id_filial);

ALTER TABLE FilialEmail
ADD CONSTRAINT fk_email_filialemail
FOREIGN KEY (id_email) REFERENCES Email(id_email);
...
ALTER TABLE FuncionarioFone
ADD CONSTRAINT fk_funcionario_funcionariophone
FOREIGN KEY (id_funcionario) REFERENCES Funcionario(id_funcionario);

ALTER TABLE FuncionarioFone
ADD CONSTRAINT fk_fone_funcionariophone
FOREIGN KEY (id_fone) REFERENCES Fone(id_fone);

ALTER TABLE FuncionarioEmail
ADD CONSTRAINT fk_funcionario_funcionarioemail
FOREIGN KEY (id_funcionario) REFERENCES Funcionario(id_funcionario);

ALTER TABLE FuncionarioEmail
ADD CONSTRAINT fk_email_funcionarioemail
FOREIGN KEY (id_email) REFERENCES Email(id_email);
